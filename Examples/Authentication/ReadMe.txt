...
All the data is encrypted prior to being transmited with Aes 128 bit encryption.
...
authentication data that will be transmited.
...
See the console for usefull information or errors.